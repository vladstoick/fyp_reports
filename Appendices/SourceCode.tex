...
\includepdf[pages=-,pagecommand={}]{Appendices/sourcecodelibrary.pdf}
\section{Code for web app}
\includepdf[pages=-,pagecommand={}]{Appendices/sourcecodeweb.pdf}
\section{Code for sql parser}
\includepdf[pages=-,pagecommand={}]{Appendices/sourcecodesql.pdf}
